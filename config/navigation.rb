  ...
  navigation.items do |home_primary|
    ...
    home_primary.item :home, 'Home', '/' do |primary|
      ...
      primary.item :community, 'Community', '/show/community' do |sub_nav|
        sub_nav.item :massanutten_history, 'Massanutten History', '/show/massanutten_history'
        sub_nav.item :community_news, 'Community News', '/show/community_news'
        sub_nav.item :community_map, 'Community Map', '/show/community_map'
        sub_nav.item :local_clubs, 'Local Clubs', '/show/local_clubs'
        sub_nav.item :great_eastern_resort, 'Great Eastern Resort', '/show/great_eastern_resort'
        sub_nav.item :evacuation_plans, 'Evacuation Plans', '/show/evacuation_plans'
